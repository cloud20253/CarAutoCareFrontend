...
// export default function QuatationList() {
...
// import VehicleDeleteModal from './VehicleDeleteModal'; // Assuming you have a modal for delete confirmation
...
//   };
  ...
  const columns: GridColDef[] = [
    ...
    // { field: 'customerAddress', headerName: 'Customer Address', flex: 1, minWidth: 200 },
    { field: 'customerMobile', headerName: 'Customer Mobile', flex: 1, minWidth: 150 },
